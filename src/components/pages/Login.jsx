...
function Login() {
  ...
  const HandlerLoginForm = async (e) => {
    ...
    try {
      ...
      NotificationManager.error(err.response.data.message, "Warning", 3002);
    }
  };
  return (
    <LoginContainer>
      <div className="loginWrapper">
        <div className="loginLeft">
          <div className="frontImgWrapper">
            <img
              src={"http://localhost:3002/images/loginpage1.png"}
              className={show1 === 1 ? "frontImg show" : "frontImg hide"}
              alt=""
            />
            <img
              src={"http://localhost:3002/images/loginpage2.png"}
              className={show1 === 2 ? "frontImg show" : "frontImg hide"}
              alt=""
            />
            <img
              src={"http://localhost:3002/images/loginpage3.png"}
              className={show1 === 3 ? "frontImg show" : "frontImg hide"}
              alt=""
            />
            <img
              src={"http://localhost:3002/images/loginpage4.png"}
...
const LoginContainer = styled.div`
  ...
  .loginLeft {
    ...
    width: 100%;
    height: 600px;
    background-image: url("http://localhost:3002/images/loginpage.png");
    min-width: 460px;
